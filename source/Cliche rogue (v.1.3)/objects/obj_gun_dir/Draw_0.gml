...
if instance_exists(obj_player)
{obj_player.face=2;
draw_sprite_ext(global.gun[0,1],0, gun_x, gun_y,image_xscale,image_yscale,dir,image_blend,image_alpha);
}
//Izquierda
if dir >= 90 and dir <= 270
if instance_exists(obj_player)
{obj_player.face=1;
draw_sprite_ext(global.gun[0,1],1, gun_x, gun_y,image_xscale,image_yscale,dir,image_blend,image_alpha);
}
