...
{
eff_img+=0.1;
draw_sprite_ext(spr_gun_switch_eff,eff_img, gun_x, gun_y,image_xscale,image_yscale,0,image_blend,image_alpha);
if eff_img >= sprite_get_number(spr_gun_switch_eff){eff=0; eff_img=0;}
}
